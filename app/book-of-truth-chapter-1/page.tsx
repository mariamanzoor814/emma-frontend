...
const CURRENT_SLUG = "book-of-truth-chapter-1";
...
export default async function Chapter1Page({ searchParams }: PageProps) {
  ...
  return (
    <AppShell topMenu={topMenu} mainMenu={mainMenu} lang={lang}>
      ...
      <BookChapterContent blocks={blocks} chapterKey="chapter1" />
